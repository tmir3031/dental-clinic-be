...
public enum BusinessErrorCode {
    ...
    LEAVE_REQUEST_NOT_FOUND("EDOT0005400", "Invalid leave request"),
    ...
    LEAVE_REQUEST_DELETE_NOT_PERMITTED_APPROVED_AND_DAYS_IN_PAST("EDOT0009400", "This leave request cannot be deleted because it has approved days off that are in the past"),
    LEAVE_REQUEST_DELETE_NOT_PERMITTED_REJECTED_LEAVE_REQ("EDOT0010405", "The leave request cannot be deleted because is rejected."),
